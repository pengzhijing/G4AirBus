...
public class FloorHeatAdapter extends BaseAdapter{
    ...
    private List<Savefloorheat> buttonarray=new ArrayList<Savefloorheat>();
    private int size;
    private LayoutInflater inflater=null;
    private HashMap<Integer, View> mView ;
    public FloorHeatAdapter(final Context context, List<Savefloorheat> list){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(view==null)
        {
            ...
            txt.setText(buttonarray.get(position).floorheat_remark);
            ceb.setImageDrawable(context.getResources().getDrawable(getResourdIdByResourdName(context,"floorheatitem_icon")));
